...
import { Users, ClipboardList, BarChart3, LogOut, Briefcase, RefreshCw, KeyRound, Eye, EyeOff, X, ArrowRight, Coins } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [adminTab, setAdminTab] = useState<'personnel' | 'puantaj' | 'reports' | 'tips'>('puantaj');
          ...
          {currentUser.role === UserRole.ADMIN ? (
            <>
              <button
                ...
                className={`flex-1 lg:w-full flex items-center justify-center lg:justify-start gap-3 px-4 py-3 lg:py-4 rounded-2xl transition-all whitespace-nowrap ${adminTab === 'puantaj' ? 'bg-slate-900 text-white shadow-xl shadow-slate-200' : 'text-slate-500 hover:bg-slate-50 font-bold'}`}
              >
              ...
              <button
                ...
                className={`flex-1 lg:w-full flex items-center justify-center lg:justify-start gap-3 px-4 py-3 lg:py-4 rounded-2xl transition-all whitespace-nowrap ${adminTab === 'tips' ? 'bg-amber-500 text-white shadow-xl shadow-amber-100' : 'text-slate-500 hover:bg-slate-50 font-bold'}`}
              >
              ...
              <button
                ...
                className={`flex-1 lg:w-full flex items-center justify-center lg:justify-start gap-3 px-4 py-3 lg:py-4 rounded-2xl transition-all whitespace-nowrap ${adminTab === 'personnel' ? 'bg-slate-900 text-white shadow-xl shadow-slate-200' : 'text-slate-500 hover:bg-slate-50 font-bold'}`}
              >
              ...
              <button
                ...
                className={`flex-1 lg:w-full flex items-center justify-center lg:justify-start gap-3 px-4 py-3 lg:py-4 rounded-2xl transition-all whitespace-nowrap ${adminTab === 'reports' ? 'bg-slate-900 text-white shadow-xl shadow-slate-200' : 'text-slate-500 hover:bg-slate-50 font-bold'}`}
              >
            ...
            <div className="flex-1 lg:w-full px-6 py-4 bg-indigo-50 text-indigo-600 rounded-3xl font-black text-[10px] lg:text-xs uppercase tracking-widest text-center">
              Personel Paneli
            </div>
          )}
        </div>
      ...
      <main className="flex-1 p-4 md:p-6 lg:p-12 lg:overflow-y-auto lg:h-screen custom-scrollbar mobile-scroll-fix">
        {currentUser.role === UserRole.ADMIN ? (
          <>
            ...
            {adminTab === 'tips' && <AdminTips users={users} entries={entries} setEntries={setEntries} />}
          </>
        ) : (
